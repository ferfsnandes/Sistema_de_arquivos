...
void File::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sizeChanged((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (File::*)(const QString & , int );
            if (_t _q_method = &File::sizeChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *File::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "FileSystemNode"))
        return static_cast< FileSystemNode*>(this);
...
// SIGNAL 0
void File::sizeChanged(const QString & _t1, int _t2)
{
